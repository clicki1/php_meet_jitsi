...
$('.wo_nw_msg_page__mobile-open-btn').on('click', function(){
  $('#wo_msg_right_prt').show()
})
$('#event-time').on( "change", function() {
  $('.create-event-submit-price').html( `(${$(this).find(':selected').data('price')}) руб.`)
} );

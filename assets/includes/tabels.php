...
define('T_USER_CATEGORIES', 'Wo_Users_Categories');
define('T_USER_TAGS', 'Wo_Users_Tags');
define('T_USER_CATEGOGIES_TAGS', 'Wo_Users_Cat_Tags');
define('T_USER_FIND_TAGS', 'Wo_UserFindTags');
define('T_EVENTS_CAT', 'Wo_Evenst_Categories');
define('T_EVENTS_TAGS', 'Wo_Etags');
define('T_MY_CITY', 'Wo_MyCity');
define('T_SYS_WALLET', 'Wo_System_Wallet');
?>

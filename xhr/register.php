...
// exit();
    ...
    if (empty($errors)) {
        ...
        $re_data  = array(
            ...
            'birthday' => '0000-00-00',
            'category_id' => (int)$_POST['user_category_id'] ?? null,
        );
        ...
        if ($register === true) {
          ...
          //  var_dump($r_id);
            ...
            if(isset($_POST['tag']) && !empty($_POST['tag'])){
                 Wo_AddUserCategoryTags($r_id, (int)$_POST['user_category_id'], $_POST['tag']);
            }else{
                 Wo_AddUserCategoryTags($r_id, (int)$_POST['user_category_id']);
            }
